...
abstract class Employee
{
	...
	Employee()
	{
		try
		{
            ...
            Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "System","Mounika@123");
	...
	public static  void display()
	{
		try
		{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/employees","System","Mounika@123");
